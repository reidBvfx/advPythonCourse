...
#           outerfaces
# date    = 2025-07-25
# needed   = - get object name, innerFaces, and outerFaces from SSM_UI
...
class vertexInfo():
    ...
    def faceToVert(self, faces):
        ...
        Returns:[list of [list of 4 connected vertices]] [[x1, x2, x3, x4], [y1 , y2, y3, y4]]
        """
        verts = []
        for face in faces:
    ...
    def getMirrorFace(self, face):
        ...
        Args: face = inner face 

        Returns: matchFace = name of mirrored face that matches argument
        """
    ...
    def moveVert(self, mirroredVerts):
        ...
        Args: mirredVerts = list of 8 verts. 0-3 belong to innerface and 4-7 belong to outer face
        """
